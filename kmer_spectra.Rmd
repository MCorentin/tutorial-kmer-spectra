...
Based on the assumption that each k-mer maps uniquely to the genome, the occurence of the homozygous peak (ie: its position on the x-axis) should represent the coverage of your sequencing data.
